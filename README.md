...
> **Important:** this repository is a **public 8,850-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,035 domains** on the canonical page below.

**Public extract:** 8,850 rows · **Live catalog:** 5,622,035 domains
...
| ----------------------- | ------------------------------------------------ |
| 8,850-row public sample | 5,622,035 live domains                           |
...
> Unique Domains. *Available .SUPPLY One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
